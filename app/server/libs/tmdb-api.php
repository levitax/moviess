...
class TMDB {
	 ...
	 * 	@return array
	 */
	public function getDiscoverPopularMovies() {

		$result = $this->_call('discover/movie', '&sort_by=popularity.desc');
	 ...
	 * 	@return Movie
	 */
	public function getDiscoverMovieByCast($cast) {

		$result = $this->_call('discover/movie', '&with_cast='.$cast);
		return $result['results'];
	}
	...
	public function getPerson($idPerson, $appendToResponse = null) {
		...
		/**
	 * 	Get a Person in array
	 *
	 * 	@param int $idPerson The Person id
	 * 	@param array $appendToResponse The extra append of the request
	 * 	@return array
	 */
	public function getPersonArray($idPerson, $appendToResponse = null) {
		$appendToResponse = (isset($appendToResponse)) ? $appendToResponse : $this->getConfig()->getAppender('person');
	 ...
	 * 	@return array[]
	 */
	public function searchMovieArray($movieTitle){
	 ...
	 * 	@return array[]
	 */
	public function searchPersonaArray($personName){
